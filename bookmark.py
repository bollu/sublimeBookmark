...
def moveBookmarkToGroup(window, bookmark, group):
    def moveViewToGroup(window, view, group):
        ...
        if group != viewGroup or viewGroup == -1 or viewIndex == -1:
            ...
            # SUBLIME_BUG
            # if the group the view is currently in has only one element
            # - i.e  this view, sublime text goes crazy.
            # It closes our options selector. So, we have to create
            ...
            # if there are n views, the last view will have index (n-1), and
